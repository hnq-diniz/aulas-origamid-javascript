...
//Sim, eu sei que adicionando scroll-behavior: smooth no HTML eu faço esta mesma função kkkk
...
function initBotaoTopo() {
  const botaoTopo = document.querySelector('.btn-top');
  const windowParcial = window.innerHeight * 0.3;

  function scrollToTop() {
    if (window.scrollY <= windowParcial) {
